...
async function Preview_form(user_key,form_id) {
    ...
    if (res.ok) {
        ...
        var preview_html = '<!doctype html><title>Form Preview</title><body class="container">' + `<form id="rendered_form" action="${user_key}/${form_id}/form_response" method="post">` + $markup.formRender("html") + '</form>' + '<div class="conatainer d-flex align-items-center text-center form_success" style="display: none !important"><div class="card" style="padding:20px;    border-radius: 20px;"><h4>Thank you!</h4><p>You have successfully joined our subscriber list.</p></div></div >' + '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">' + '<script src="http://localhost:8080/static/preview.js"></script>' + '<link rel="stylesheet" href="http://localhost:8080/static/form_response.css">' + '<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>' + '<script>$(document).ready(function () {     console.log("ready!");}); </script>' + '</body></html>';
