...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2022 at 11:17 PM
...
--
ALTER TABLE `campaigns_details`
  MODIFY `campaign_key` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;
...
--
ALTER TABLE `group_details`
  MODIFY `group_key` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `subscriber_of_users`
--
ALTER TABLE `subscriber_of_users`
  MODIFY `subscriber_key` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
